"""
Django settings for CodeLogic - Pixel Art Quiz Platform
"""
...
# Cloud Storage for Media Files (Digital Ocean Spaces)
...
# CORS settings
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,http://127.0.0.1:3000,https://codelogic-backend-xm7wi.ondigitalocean.app').split(',')
