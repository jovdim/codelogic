...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        learning_resources = [
            {
                ...
                'slug': 'html5-notes',
                'description': 'Complete guide to HTML5 markup and web structure',
                'category': 'web-development',
                'language': 'HTML',
                'difficulty': 'beginner',
                'pdf_file': 'learning_resources/pdfs/HTML5NotesForProfessionals.pdf',
                'thumbnail': 'learning_resources/thumbnails/HTML5Grow.png',
                'pages': 200,
                'read_time': '4 hours',
                'topic': html_topic,
            },
            {
                ...
                'pdf_file': 'learning_resources/pdfs/CSSNotesForProfessionals.pdf',
                'thumbnail': 'learning_resources/thumbnails/CSSGrow.png',
                'pages': 300,
                'read_time': '6 hours',
                'topic': css_topic,
            },
            {
                ...
                'language': 'JavaScript',
                'difficulty': 'intermediate',
                'pdf_file': 'learning_resources/pdfs/JavaScriptNotesForProfessionals.pdf',
                'thumbnail': 'learning_resources/thumbnails/JavaScriptGrow.png',
                'pages': 400,
                'read_time': '8 hours',
                'topic': js_topic,
            },
            {
                ...
                'slug': 'reactjs-notes',
                'description': 'Learn React component-based UI development',
                'category': 'web-development',
                'language': 'JavaScript',
                'difficulty': 'intermediate',
                'pdf_file': 'learning_resources/pdfs/ReactJSNotesForProfessionals.pdf',
                'thumbnail': 'learning_resources/thumbnails/ReactJSGrow.png',
                'pages': 250,
                'read_time': '5 hours',
                'topic': react_topic,
            },
            {
                ...
                'slug': 'python-notes',
                'description': 'Complete Python programming reference',
                'category': 'programming',
                'language': 'Python',
                'difficulty': 'intermediate',
                'pdf_file': 'learning_resources/pdfs/PythonNotesForProfessionals.pdf',
                'thumbnail': 'learning_resources/thumbnails/PythonGrow.png',
                'pages': 500,
                'read_time': '10 hours',
                'topic': py_topic,
            },
            {
                ...
                'language': 'SQL',
                'difficulty': 'intermediate',
                'pdf_file': 'learning_resources/pdfs/SQLNotesForProfessionals.pdf',
                'thumbnail': 'learning_resources/thumbnails/SQLGrow.png',
                'pages': 200,
                'read_time': '4 hours',
                'topic': sql_topic,
            },
            {
                ...
                'slug': 'bash-notes',
                'description': 'Command line scripting and automation',
                'category': 'devops',
                'language': 'Bash',
                'difficulty': 'beginner',
                'pdf_file': 'learning_resources/pdfs/BashNotesForProfessionals.pdf',
                'thumbnail': 'learning_resources/thumbnails/BashGrow.png',
                'pages': 150,
                'read_time': '3 hours',
                'topic': bash_topic,
            },
        ...
        for res_data in learning_resources:
            topic = res_data.pop('topic')
            res, created = LearningResource.objects.get_or_create(
                slug=res_data['slug'],
                defaults=res_data
            )
            if created:
                self.stdout.write(f'  ✓ Created learning resource: {res.title}')
        
        self.stdout.write(self.style.SUCCESS(f'✓ Successfully seeded {len(learning_resources)} learning resources'))
