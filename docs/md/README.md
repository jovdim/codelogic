...
These are the docs for CodeLogic. Start at the top and read down.
...
- [How the Backend is Built](./backend/architecture.md)
- [Accounts (users + login)](./backend/accounts-app.md)
- [Game (quiz stuff)](./backend/game-app.md)
- [List of All API URLs](./backend/api-endpoints.md)
- [Admin Panel Guide](./backend/admin-panel.md)
- [Helpful Commands](./backend/management-commands.md)
- [Game Rules (XP, hearts, etc.)](./backend/gamification-mechanics.md)

## Frontend (the website)

- [Frontend Overview](./frontend/README.md)
- [How the Frontend is Built](./frontend/architecture.md)
- [Pages and URLs](./frontend/routing.md)
- [Components](./frontend/components.md)
- [Talking to the Server](./frontend/state-and-api.md)
- [Music and Sound](./frontend/audio-system.md)
- [Colors and Style](./frontend/styling.md)
