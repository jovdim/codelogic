...
// Mock certificates data - will be replaced with API
          ...
          <div class="certificate">
            <div class="border-frame">
              ...
              <div class="stats">
                ...
                <span>Time: ${cert.timeSpent}</span>
              </div>
            </div>
            <div class="date">Completed: ${new Date(cert.completedAt).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</div>
          </div>
        </body>
      </html>
    `;
    ...
    <ProtectedRoute>
      <Sidebar>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-[#1a1a2e] rounded-xl p-4 border border-[#2d2d44]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-white">
                      {certificates.reduce((acc, c) => acc + c.totalLevels, 0)}
                    </p>
            ...
            {filteredCerts.length === 0 ? (
              ...
              <div className="grid gap-4">
                {filteredCerts.map((cert) => (
                  <div
                    key={cert.id}
                    className="bg-[#1a1a2e] rounded-xl p-5 border border-[#2d2d44] hover:border-[#3d3d5c] transition-colors"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div
                          className="w-14 h-14 rounded-xl flex items-center justify-center text-2xl"
                          style={{ backgroundColor: `${cert.accentColor}20` }}
                        >
                          {cert.topicIcon}
                        </div>
                        <div>
                          ...
                          <p className="text-sm text-gray-400">{cert.category}</p>
        ...
        {selectedCert && (
          ...
          >
            <div
              className="bg-[#fefefe] rounded-xl p-6 max-w-md w-full text-center"
            ...
            >
              <div className="border-4 border-double border-yellow-600/30 p-6 rounded-lg">
                ...
                <div className="flex justify-between text-xs text-gray-400 mt-6 pt-4 border-t">
                  ...
                  <span>Levels: {selectedCert.totalLevels}</span>
                </div>
